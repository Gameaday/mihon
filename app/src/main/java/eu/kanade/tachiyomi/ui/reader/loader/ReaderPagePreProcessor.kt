 ...
 *   [Downloader][eu.kanade.tachiyomi.data.download.Downloader] logic) to skip pages
...
class ReaderPagePreProcessor(
    ...
    companion object {
         ...
         * Matches the value used by [Downloader][eu.kanade.tachiyomi.data.download.Downloader].
         */
