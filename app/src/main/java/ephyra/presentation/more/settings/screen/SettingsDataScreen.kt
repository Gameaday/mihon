...
import ephyra.presentation.more.settings.screen.data.CreateBackupScreen
import ephyra.presentation.more.settings.screen.data.RestoreBackupScreen
import ephyra.presentation.more.settings.screen.data.StorageInfo
import ephyra.presentation.more.settings.widget.BasePreferenceWidget
...
object SettingsDataScreen : SearchableSettings {
    ...
    fun storageLocationPicker(
        storageDirPref: ephyra.core.common.preference.Preference<String>,
